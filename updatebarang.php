...
<?php
    ...
    if (isset($_POST["ok"])) {
        ...
        $simpan=mysqli_query($koneksi, "update into barang set 
        id_barang='$id_barang',
...
?>
    ...
    <input values="<?php echo "$row[id_barang];"?>" disable="true" type="text" class="form-control" placeholder="Id barang.." name="id_barang">
    </div><br>
