...
?>
    ...
    <input type="number" class="form-control" placeholder="Id barang.." name="jumlah_barang">
    </div><br>

    <div class="form group">
    <label for="kondisi barang"><b>Kondisi Barang</b></label>
    <input type="text" class="form-control" placeholder="kondisi barang.." name="kondisi">
    </div><br>
