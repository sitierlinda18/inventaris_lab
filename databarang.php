...
</svg><?php echo "<a href='updbarang.php?id=$row[id_barang]'> UPDATE</a> ||
        <a text=red href='deletebarang.php?id=$row[id_barang]'> DELETE ";?><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash3-fill" viewBox="0 0 16 16">
